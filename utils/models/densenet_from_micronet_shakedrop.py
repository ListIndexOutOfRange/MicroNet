...
#from ..attention_best import AttentionLayer

__all__ = ['densenet_from_micronet_shakedrop']


from torch.autograd import Variable

class Bottleneck(nn.Module):
    def __init__(self, inplanes, expansion=4, growthRate=12, dropRate=0,p_shakedrop = 1.0):
...
class BasicBlock(nn.Module):
    def __init__(self, inplanes, expansion=1, growthRate=12, dropRate=0,p_shakedrop = 1.0):
...
def densenet_from_micronet_shakedrop(**kwargs):
    """
    Constructs a ResNet model.
    """
    return DenseNet_MicroNet_Shake(**kwargs)